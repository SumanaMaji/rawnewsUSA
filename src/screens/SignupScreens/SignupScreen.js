...
const SignupScreen = ({navigation}) => {
  ...
  console.log('locc'+userLatitude+''+userLongitude);
  ...
  const handleSubmitPress = () => {
    ...
    setLoading(true);
    fetch(Urls.register+'?data={"data":{"name":"'+userName+'","email":"'+userEmail+'","phone":"'+userPhone+'","password":"'+userPassword+'","user_lat":"'+userLatitude+'", "user_long":"'+userLongitude+'"}}', {
      method: 'POST',
      headers: new Headers({
  ...
  return (
    <View style={styles.mainContainer}> 
      ...
      <ScrollView>
        ...
        <View>
         <Text style={styles.signingMessage}>By signing up you agree to receive messages at the number provided.{'\n'}Reply STOP to unsubscribe. </Text> 
        </View>      
      </ScrollView>   
    </View>
  );
