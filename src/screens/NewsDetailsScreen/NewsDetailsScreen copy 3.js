...
const NewsDetailsScreen = ({ route, navigation, props }) => {
  ...
  //const url_settings = 'rawnews:newsdetailsscreen/2762//';
    const url_settings = 'rawnews://news-details-screen/'+itemId;
    ...
    fetch(Urls.getExclusiveNewsDetails + '?data={"data":{"id":"' + itemId + '","flag":"' + flag + '"}}', {
      ...
      .then(responseJson => {
        ...
        if (responseJson.error == 0) {
          ...
          setTableData(data);
          console.log("newsdetails--"+JSON.stringify(data));
                 ...
                 // borderColor: 'orange',
                  marginTop: 22 }}>
                    ...
                    /> */}
                        ...
                        <WebView
                style={{flex:1,  width: 380, height: 200 }}
                javaScriptEnabled={true}
                domStorageEnabled={true}
                source={{ uri: showModal.data.url }}
              />
                     {/* <TouchableOpacity
              style={[styles.button, styles.buttonClose]}
              onPress={() => hideActiveVideoModal()}>
                ...
                (tableData.mediatype != null) ?
                  ...
                  >
                    <Image
                      resizeMode='contain'
                      source={{
                        uri: (tableData.mediatype == 'I') ? tableData.news_image : (tableData.youtube_video_image != '') ? tableData.youtube_video_image : tableData.videoimage
                      }}
...
const styles = StyleSheet.create({
  ...
  child: {
    color: 'red',
    fontSize: 600, // exaggerated for example
    lineHeight: 34,
  }
});
const tagsStyles = {
