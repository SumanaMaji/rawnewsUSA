...
const NewsAddScreen = ({navigation}) => {
  ...
  useEffect(() => {
   ...
   // console.log("youtubeVideoData--"+JSON.stringify(youtubeVideoData.status.uploadStatus));
  }, [userId]);
  const testdata = {
    "kind": "youtube#video",
    "etag": "ig-Lk902LHpIu4UOwMLPbXwD9ik",
    "id": "MGX42e21huQ",
    "snippet": {
      "publishedAt": "2023-07-19T13:18:30Z",
      "channelId": "UCchBlYHJFxb73cnWBMJHJQg",
      "title": "This is a new title",
      "description": "This is a new description",
      "thumbnails": {
        "default": {
          "url": "https://i.ytimg.com/vi/MGX42e21huQ/default.jpg",
          "width": 120,
          "height": 90
        },
        "medium": {
          "url": "https://i.ytimg.com/vi/MGX42e21huQ/mqdefault.jpg",
          "width": 320,
          "height": 180
        },
        "high": {
          "url": "https://i.ytimg.com/vi/MGX42e21huQ/hqdefault.jpg",
          "width": 480,
          "height": 360
        }
      },
          ...
          var uploader = new YTDAPI({
           ...
           // token: 'ya29.a0AbVbY6MQlNOLcD5vE7qNgL-dw77bwMYKogi_WQ3wltJ4QKHSQrkQvs6knYdDy6i1qQDr7-Tm0Lg0m6YTunUd-RrE--0L0VLyorsa4R_2q4tPf6JJVFpfVEdezRkR3VoUjyjhjBkoq2_D5cjiSi1G68rX4u1B1kGPaCgYKATQSARISFQFWKvPlf3O73ssOQJBAg6VQzrjvfg0167',
            ...
            onComplete: function(data) {
              ...
              // console.log("imagescreenshot---"+JSON.parse(data.id));
               setYoutubeVideoData(data);
              // setVideoId(data.id);

             // console.log("imagescreenshot---"+JSON.parse(data.id));
             // setYoutubeVideoData(testdata);
              console.log('hhhhh'+ JSON.stringify(youtubeVideoData))
             setVideoId(youtubeVideoData.id);
             setUploadedStatus(youtubeVideoData.status.uploadStatus);
             setVideoimageUrl(youtubeVideoData.snippet.thumbnails.high.url);
            }.bind(this)
          });
