...
const NewsAddScreen = ({navigation}) => {
  ...
  const accessToken = 'ya29.a0AbVbY6PaW8tMVPUHt5cb9f1v0bfooznEGl8LgQg8k2V2v1Vs18BFyues2M_ADLNShgxAxDt8sEMn_80WqyVDJgoL8LAsWExaTZaTocHQCgAeKb-NkBmv-hEqrEoMVGhek0l8lwmxDk14A6l8rfO5J5C8JXzyaCgYKAeYSARISFQFWKvPl3f4l6KgsrI1preRq5kaimg0163';
  useEffect(() => {
    readUserId('user_id');
  }, [userId]);
  ...
  const uploadMediaToYouTube = async (accessToken, newsFile) =>{                
